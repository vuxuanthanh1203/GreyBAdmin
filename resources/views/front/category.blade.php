            ...
            <div class="row">
                ...
                <div class="left-content col l-3">
                    ...
                    <li id="filter-product">
                        ...
                        <ul class="subnav">
                            @foreach($categories_left as $cat_left)
                                ...
                                <li class="left_cat_active"><a href="{{url('category/'.$cat_left->category_slug)}}" class="category_left_menu category_active">{{$cat_left->category_name}}</a></li>
                                @else
                                <li><a href="{{url('category/'.$cat_left->category_slug)}}" class="category_left_menu">{{$cat_left->category_name}}</a></li>
                                @endif
                            @endforeach
                        </ul>
                    </li>
                    <li id="trademark-product">
                        ...
                        <ul class="subnav">
                            <li>
                                <a href="{{url('brand/converse')}}" class="category_left_menu">Converse</a>
                            </li>
                            <li>
                                <a href="{{url('brand/puma')}}" class="category_left_menu">Puma</a>
                            </li>
                            <li>
                                <a href="{{url('brand/vans')}}" class="category_left_menu">Vans</a>
                            </li>
                            <li>
                                <a href="{{url('brand/fila')}}" class="category_left_menu">Fila</a>
                            </li>
                            <li>
                                <a href="{{url('brand/greyb')}}" class="category_left_menu">GreyB</a>
                            </li>
