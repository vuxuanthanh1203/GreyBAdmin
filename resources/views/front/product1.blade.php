            ...
            @foreach ($product as $item)
                ...
                <div class="product-content col l-6 c-12 m-12">
                    ...
                    <div class="buy-addcart row">
                        ...
                        <a href="{{url('/cart')}}" class="buy-product" onclick="add_to_cart('{{$product[0]->id}}','{{$product_attr[$product[0]->id][0]->size_id}}')">MUA NGAY</a>
                    </div>
                    ...
                    <div class="product-item col l-3 c-4 m-4 sm-6">
                        ...
                        <span class="special-price">
                            <span class="tp_product_price">
                                <h1>{{$list->price}} <sup>đ</sup></h1>
                            </span>
                            <span>
                                <h1>{{$list->mrp}}<sup>đ</sup></h1>
                            </span>
                        </span>
