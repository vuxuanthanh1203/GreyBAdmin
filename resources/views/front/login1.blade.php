                        ...
                        <div class="row wrap-remember">
                            <div class="col l-6 m-6 s-12 btn-remember">
                                {{-- <label for="rememberme" class="rememberme">
                                    <input type="checkbox" name="rememberme" id="rememberme" style="display: inline-block">
                                    <span> Ghi nhớ đăng nhập </span>
                                </label> --}}
                            </div>
                            <a href="{{url('/get_password')}}" class="col l-6 m-6 s-12" href="#" style="display: block;text-align: right; color: #111111; padding: 0 10px">
