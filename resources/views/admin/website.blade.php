...
@section('page_title', 'Website Infomation')
...
<div class="content">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h3 class="page-title">Website Infomation</h3>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                                <a href="{{url('admin/website/manage_website')}}" class="add-new">
                                                        ...
                                                        <table id="datatable"
                                                            ...
                                                            <thead class="thead-dark">
                                                                <tr role="row">
                                                                    ...
                                                                    <th class="sorting" tabindex="0"
                                                                        aria-controls="datatable" rowspan="1"
                                                                        colspan="1" style="width: 50px;">Phone
                                                                    </th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr role="row" class="odd product_content text-center">
                                                                    ...
                                                                    <td>
                                                                        <a href="{{url('admin/website/manage_website')}}/{{$item->id}}">
                                                                        ...
                                                                        {{-- <a href="{{url('admin/website/delete')}}/{{$item->id}}">
