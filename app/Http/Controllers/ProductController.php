...
class ProductController extends Controller
{
    ...
    public function manage_shoes(Request $request, $id=''){
        if ($id > 0) {
            $arr = Product::where(['id'=>$id])->get();
        ...
        $result['category'] = DB::table('categories')->where(['status'=>1])->where(['sub_category_id'=>1])->get();

        $result['sizes'] = DB::table('sizes')->where(['status'=>1])->where(['sub_category_id'=>1])->get();

        $result['brands'] = DB::table('brands')->where(['status'=>1])->get();

        $result['types'] = DB::table('types')->get();

        return view('admin/manage_shoes', $result);
    }

    public function manage_shoes_process(Request $request){
        if($request->post('id') > 0) {
            $image_validation = "mimes:jpeg,jpg,png";
        } else {
            $image_validation = "required|mimes:jpeg,jpg,png";
    ...
    public function manage_shirt(Request $request, $id=''){
        if ($id > 0) {
            $arr = Product::where(['id'=>$id])->get();
        ...
        $result['category'] = DB::table('categories')->where(['status'=>1])->where(['sub_category_id'=>2])->get();

        $result['sizes'] = DB::table('sizes')->where(['status'=>1])->where(['sub_category_id'=>2])->get();

        $result['brands'] = DB::table('brands')->where(['status'=>1])->get();

        $result['types'] = DB::table('types')->get();

        return view('admin/manage_shirt', $result);
    }

    public function manage_shirt_process(Request $request){
        if($request->post('id') > 0) {
            $image_validation = "mimes:jpeg,jpg,png";
        } else {
            $image_validation = "required|mimes:jpeg,jpg,png";
    ...
    public function manage_accessory(Request $request, $id=''){
        if ($id > 0) {
            $arr = Product::where(['id'=>$id])->get();
        ...
        $result['category'] = DB::table('categories')->where(['status'=>1])->where(['sub_category_id'=>3])->get();

        $result['sizes'] = DB::table('sizes')->where(['status'=>1])->where(['sub_category_id'=>3])->get();

        $result['brands'] = DB::table('brands')->where(['status'=>1])->get();

        $result['types'] = DB::table('types')->get();

        return view('admin/manage_accessory', $result);
    }

    public function manage_accessory_process(Request $request){
        if($request->post('id') > 0) {
            $image_validation = "mimes:jpeg,jpg,png";
        } else {
            $image_validation = "required|mimes:jpeg,jpg,png";
    ...
    public function active_product(Request $request, $id)
    {
        ...
        $model->save();
        // $request->session()->flash('message', 'Product Status Updated !');
        return response()->json(['status'=>'success','msg'=>'Product Status Updated !']);
    }
